...
namespace pps
{
    ...
    struct Value
    {
        ...
        Value(ValueType _type, std::variant<bool, int, std::string> _value) : type(_type), value(_value) {}
    ...
    {
        BoolValue(bool _value) : Value(ValueType::tBool, _value) {}
    ...
    {
        IntValue(int _value) : Value(ValueType::tInt, _value) {}
        void print() const override;
    ...
    {
        StringValue(const std::string &_value) : Value(ValueType::tString, _value) {}
        StringValue(const char _char) : Value(ValueType::tString, std::string(1, _char)) {}
        void print() const override;
